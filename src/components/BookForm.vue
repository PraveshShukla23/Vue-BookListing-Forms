<template>
  <form v-on:submit.prevent="bookSubmit(bookData)" class="" action="#" method="post">
    ...
    <div>
      <label for="finishedReading"> Finished Reading<input type="checkbox" v-model="bookData.finishedReading"></label>
    </div>
    <div>
      <label for="borrowed"> Borrowed<input type="radio" value="borrowed" v-model="bookData.ownership"></label>
      <label for="bought"> Bought<input type="radio" value="bought" v-model="bookData.ownership"></label>
    </div>
